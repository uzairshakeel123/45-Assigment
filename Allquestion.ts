...
//  Question Number 11
// let friendName = ["uzair","Ahmad","zain","ali"];
...
//  Question Number 14
// let guestList = ['Ammi','Abbu','uzair Bhai','eman api','Danish Bhai'];
...
//  Question Number 16
// var guestList = ['Ammi','Abbu','uzair Bhai','eman api','Danish Bhai'];
...
// //  Question Number 20
// let country = ['Pakistan','sodia','Dubai','Us','Uk'];
// console.log(country);
...
// let userLoginID = ['admin','uzair', 'ali','hannan','sad','danish'];
...
//Exercise 30 - Hello admin
// var userLoginID =['admin','uzair', 'ali','hannan','sad','danish'];
...
// let currentUsers = ['uzair','ali','Ahmed','Danish','hannan'];
